---
description: Create an order request to search for flights using the "Smart Search" feature.
---
...
No preceding function needs to be called before `Smart Search`.
...
**`maxResponseTime`  **<mark style="color:blue;">**integer**</mark>**  **<mark style="color:green;">**Required**</mark>

The longest duration of the first response (in milliseconds). By default, it is 10 seconds.
...
**`smartEnd`  **<mark style="color:blue;">**Boolen**</mark>
